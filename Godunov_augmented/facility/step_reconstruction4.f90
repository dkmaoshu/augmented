...
private compute_tvd_limiters, fix_limiter_reversity, compute_half_steps, conservation_check, reconstruction_output,ABS_mass_HS, ABS_velocity_HS, Vaver_via_Paver_drho, &
        Paver_via_Vaver_dv, Vaver_via_drho_dv, Paver_via_drho_dv, entropy_reconstruction
...
!real*8, dimension(0:cells_number) :: d_rho_tvd,d_v_tvd,d_p_tvd
!real*8 :: dp1,dp2
real*8 :: d_rho_temp, d_v_temp, dp_star, drho0, dp0, paver, alpha !,v2
...
!   d_v(i)=d_v_tvd(i)
!   call Paver_via_drho_dv(rho,d_v_tvd(i),d_rho(i),p,temp_pp) 
!   p_aver(i)=temp_pp
!   call Vaver_via_Paver_drho(rho,d_rho(i),v,p,p_aver(i),v_aver(i))               
